...
func Calendar(cssDir []string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<h1>Calendar </h1><button hx-post=\"/calendar/request/\" hx-swap=\"outterHTML\">Button Request</button> <center><div id=\"calendar\"></div></center><script>\n        window.addEventListener(\"load\", (event) =>{\n            toggleVisibility();\n        });\n        \n        function showCalendar(gridcall){\n            var calendarEl = document.getElementById('calendar');\n            var calendar = new FullCalendar.Calendar(calendarEl, {\n                dateClick: function(info) {\n                    showCalendar('dayGridMonth');\n                },\n                headerToolbar: {\n                    left: 'prev,next today',\n                    center: 'title',\n                    right: 'timeGridDay,timeGridWeek,dayGridMonth,multiMonthYear'\n                },\n                initialView: gridcall,\n                fixedWeekCount: false\n            });\n            calendar.render();\n        }\n\n        function toggleVisibility() {\n            // desktop view\n            if (window.innerWidth <= 768) \n                showCalendar('timeGridWeek');\n            // mobile view\n            else \n                showCalendar('dayGridMonth');\n        }\n        // window.addEventListener('resize', toggleVisibility);\n        // toggleVisibility();\n        </script>")
